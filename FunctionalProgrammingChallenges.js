...
function getRating(watchList) {
    ...
    let nolanMoviesRating = nolanMovies.map(movie => movie.imdbRating);

    let averageRating = nolanMoviesRating.reduce((sum, rating) => sum + Number(rating), 0) / nolanMovies.length;
